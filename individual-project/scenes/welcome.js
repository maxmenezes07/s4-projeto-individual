...
class Welcome extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("play", "assets/buttons/play.png"); // Carregando a imagem do botão "play"
    }

    // Função chamada quando a cena é criada
    create() {
        // Configuração das teclas e variáveis da cena
        console.log("Welcome Scene Loaded");
        ...
        this.playBt.on('pointerdown', function () {
            console.log("Play button clicked. Name filled:", this.nameFilled); // Debug log
            if (this.nameFilled) {
                console.log("Starting Cyberbird scene...");
                this.game.highScore = 0;
                this.scene.start('Cyberbird', this.game);
            }
        }, this);
